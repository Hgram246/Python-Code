...
df = pd.read_excel("/Users/henryg/Downloads/NationDistributorStocklist.xlsx")
...
for asin in asins:
    row_index = df.index[df['ASIN'] == asin].tolist()
...
df["Sale Price Per"].to_excel('/Users/henryg/Documents/Business_Spreadsheets/NationDistributorAmazonPrices.xlsx', index=False)
