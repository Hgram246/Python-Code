...
df = pd.read_excel("/Users/henryg/Downloads/Amazon_Products.xlsx")
...
df["Sale Price Per"].to_excel('/Users/henryg/Downloads/Amazon_Products_Updated_Prices.xlsx', index=False)
